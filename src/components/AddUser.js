...
const AddUser = () => {
    ...
    return ( 
        <div>
            <h1 className="text-center"><strong>Add User</strong></h1>
            <br />
            <Formik
            initialValues={{
                name: '',
            ...
            onSubmit={(values, {setSubmitting}) => {
                ...
                axios.post('http://localhost:5000/users/add', user)
                    ...
                    .catch(err => window.alert("Creating new user failed !!! Email already registered."))
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row justify-content-md-center">
                            <div className="col col-lg-2">
                                <button type="submit" className="btn btn-success"><strong>Add User</strong></button>
                            </div>
                        </div>          
                    </div>
                </form>
